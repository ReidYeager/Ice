...
public:
  ...
  virtual b8 ResizeBufferMemory(Ice::Buffer* _buffer, u32 _newElementCount) = 0;
  ...
  virtual b8 InitializeRenderComponent(Ice::RenderComponent* _component,
                                       Ice::BufferSegment const _TransformBuffer) = 0;

  // TODO : Separate vkDescriptorSet from object's renderer/camera component.
  //  Put in transform?
  //    Does not take into account possible expansion of object buffer data
  //    But individual object info is usually vertex specific, thus passed in vertex buffer
  virtual b8 UpdateRenderComponent(Ice::RenderComponent* const _component,
                                   Ice::BufferSegment const _transformBufferSegment) = 0;
  virtual b8 UpdateCameraComponent(Ice::CameraComponent* const _component,
                                   Ice::BufferSegment const _transformBufferSegment) = 0;
  virtual void DestroyRenderComponent(Ice::RenderComponent* _component) = 0;
